...
$sql = "INSERT INTO `allproductsproduct`(`productname`, `productprice`, `productimage`, `onweremail`, `pdiscount`, `pdescription`, `sellingprice`, `productcategory`,`shopeaddress`,`image1`,`image2`,`image3`,`image4`,`image5`,`size`)
                VALUES ('$productname','$p_totalprice','$fileName','$p_owneremail','$p_descount','$p_des','$p_sell','$p_category','$p_address','$fileName1','$fileName2','$fileName3','$fileName4','$fileName5','$p_size')";
