...
VALUES ('$productimage','$productnames','$p_totalprice','$p_sell_price','$p_descount','$p_des','$p_seller_email_name','$p_seller_shope_address','$buyeraddress','$product_buyer_mobile_no','$delever_address_of_buyer','$nameofbuyer','$p_buyer_email','$yes','$p_pick','$p_id')";
