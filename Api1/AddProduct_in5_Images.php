...
if(empty($fileName1)){
    ...
    echo $errorMSG;
        ...
        $valid_extensions1 = array('jpeg','jpg','png','gif','webp');
...
if(empty($fileName2)){
    ...
    echo $errorMSG;
        ...
        $valid_extensions2 = array('jpeg','jpg','png','gif','webp');
...
if(empty($fileName3)){
    ...
    echo $errorMSG;
        ...
        $valid_extensions3 = array('jpeg','jpg','png','gif','webp');
...
if(empty($fileName4)){
    ...
    echo $errorMSG;
        ...
        $valid_extensions4 = array('jpeg','jpg','png','gif','webp');
